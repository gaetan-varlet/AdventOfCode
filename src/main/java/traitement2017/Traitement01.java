...
public class Traitement01 {
	...
	/**
	 * parcours de la chaine chiffre par chiffre de manière circulaire,
	 * en se disant que le premier chiffre est à la suite du dernier. <br>
	 ...
	 * @return la somme
	 */
	protected int traitement(String chaine, int pas){
		int somme = 0;
