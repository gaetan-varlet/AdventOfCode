...
public class Exercice9Test{
	...
	monReader.lireFichier("src/test/resources/inputTestExercice9a.1.txt", charset);		
	assertEquals(1, traitement9.getNombreDeGroupe());
	assertEquals(1, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.2.txt", charset);		
	assertEquals(3, traitement9.getNombreDeGroupe());
	assertEquals(6, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.3.txt", charset);		
	assertEquals(3, traitement9.getNombreDeGroupe());
	assertEquals(5, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.4.txt", charset);		
	assertEquals(6, traitement9.getNombreDeGroupe());
	assertEquals(16, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.5.txt", charset);		
	assertEquals(1, traitement9.getNombreDeGroupe());
	assertEquals(1, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.6.txt", charset);		
	assertEquals(5, traitement9.getNombreDeGroupe());
	assertEquals(9, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.7.txt", charset);		
	assertEquals(5, traitement9.getNombreDeGroupe());
	assertEquals(9, traitement9.getScore());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9a.8.txt", charset);		
	...
	Traitement9 traitement9 = new Traitement9();
	monReader.addLigneListener(traitement9);
	monReader.lireFichier("src/test/resources/inputTestExercice9b.1.txt", charset);		
	assertEquals(0, traitement9.getNombreCaractereEntreChevron());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9b.2.txt", charset);		
	assertEquals(17, traitement9.getNombreCaractereEntreChevron());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9b.3.txt", charset);		
	assertEquals(3, traitement9.getNombreCaractereEntreChevron());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9b.4.txt", charset);		
	assertEquals(2, traitement9.getNombreCaractereEntreChevron());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9b.5.txt", charset);		
	assertEquals(0, traitement9.getNombreCaractereEntreChevron());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9b.6.txt", charset);		
	assertEquals(0, traitement9.getNombreCaractereEntreChevron());
	
	monReader.lireFichier("src/test/resources/inputTestExercice9b.7.txt", charset);		
